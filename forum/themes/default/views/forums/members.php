    ...
    foreach ($members as $user) {
        ...
        <div class="content-box">
            ...
            <div class="content-box-middle">
                <h2 style="margin-top:10px"><?= '<a href="'.site_url('users/profile/'.$user->username).'">'.$user->first_name.' '.$user->last_name.' ('.$user->username.')</a> <span class="label label-primary" style="padding:0.2em 0.6em 0.3em 0.6em;">'.$user->group.'</span>'; ?></h2>
