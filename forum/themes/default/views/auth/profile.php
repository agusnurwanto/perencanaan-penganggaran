...
<div class="col-sm-8">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li><a href="#change_password" role="tab" data-toggle="tab"><?= lang('change_password'); ?></a></li>
        <?php } ?>
        ...
        <div role="tabpanel" class="tab-pane fade" id="edit">
            ...
            <div class="page-box">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" class="form-control" id="username" value="<?= $user->username ?>" required="required" data-fv-notempty-message="<?=lang('username_required');?>" />
                </div>
                <div class="form-group">
                    <?= lang('email', 'email'); ?>
                ...
                <div class="form-group">
                    <?= lang('dob', 'dob'); ?>
                    <?= form_input('dob', set_value('dob', $user->dob), 'class="form-control tip" id="dob" placeholder="yyyy-mm-dd"'); ?>
                </div>
                <div class="form-group">
                    <?= lang('gender', 'gender'); ?>
                    <?php
                    $ge = ['male' => lang('male'), 'female' => lang('female')];
                    echo form_dropdown('gender', $ge, ($_POST['gender'] ?? $user->gender), 'class="tip form-control select2" id="gender" required="required" style="width:100%" data-fv-notempty-message="' . lang('gender_required') . '"');
                    ?>
                </div>
                <div class="form-group">
