...
<html lang="en"<?php echo (in_array(get_userdata('language'), array('arabic')) ? ' dir="rtl"' : null); ?>>
	...
	<body>
		...
		<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v3.2&appId=<?php echo get_setting('facebook_app_id'); ?>&autoLogAppEvents=1"></script>
