...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-success">
	<a class="navbar-brand --xhr" href="<?php echo base_url(); ?>">
		<img src="<?php echo get_image('settings', get_setting('app_logo')); ?>" />
	...
	<div class="collapse navbar-collapse" id="navbarExpand">
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item dropdown d-none d-lg-block d-xl-block">
				...
				<ul class="dropdown-menu dropdown-menu-right">
					<li class="nav-item">
						<h6 class="nav-link dropdown-header d-none d-md-block d-lg-block d-xl-block">
					...
					<li class="nav-item">
						<a class="nav-link --xhr text-danger" href="<?php echo base_url('auth/sign_out'); ?>">
			...
			<li class="nav-item d-none d-lg-block d-xl-block">
				<a href="<?php echo base_url('auth'); ?>" class="nav-link" onclick="component.login(this, event)">
					<i class="mdi mdi-login"></i>
