...
({
	onComplete: function(barcode, qty)
	{
		...
		if($('#voucher_input').length)
		{
			$('#voucher_input').focus().val('').val(barcode_output)
		}
		else if($('.search-product').length)
		{
			$('.search-product').focus().val('').val(barcode_output)
		}
		else if($('#barcode_input').length)
		{
			$('#barcode_input').focus().val('').val(barcode_output)
		}
		else if($('#product_' + barcode_output).length)
		{
			$('#product_' + barcode_output).trigger('click')
		}
		else
		{
			return false;
