...
class Jenis_pekerjaan extends Aksara
{
	...
	public function index()
	{
		...
		else
		{
			...
			->add_action('option', '../variabel', 'Variabel', 'btn-primary ajaxLoad', 'fa fa-barcode', array('id_musrenbang_jenis_pekerjaan' => 'id', 'per_page' => null))
			->add_action('option', '../pertanyaan', 'Pertanyaan', 'btn-danger ajaxLoad', 'fa fa-lightbulb-o', array('id_musrenbang_jenis_pekerjaan' => 'id', 'per_page' => null))
			...
			(
				...
				array
				(
					0								=> '<label class="label bg-primary">isian</label>',
					1								=> '<label class="label bg-teal">Alamat</label>'
				)
			)
			->set_validation
			(
