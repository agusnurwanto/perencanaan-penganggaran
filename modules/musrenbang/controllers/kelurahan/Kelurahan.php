...
class Kelurahan extends Aksara
{
	function __construct()
	{
		...
		elseif(3 == get_userdata('group_id'))
		{
			generateMessages(301, 'Silakan pilih RW terlebih dahulu', base_url('musrenbang/kelurahan/rw'));
		}
	...
	public function index()
	{
		...
		{
			$this->where('id_kel', $this->input->get('id_kel'));
		}
		$this->set_title(phrase('silakan_pilih_kelurahan'))
		->set_icon('mdi mdi-mushroom')
		->set_field('kode', 'sprintf')
		->set_field('nama_kelurahan', 'hyperlink', 'musrenbang/kelurahan/rw', array('id_kel' => 'id'))
