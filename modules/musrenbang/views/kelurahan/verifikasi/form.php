					...
					<div class="col-md-10 col-md-offset-1">
						<div class="row">
							<div class="col-md-6">
								...
								<div class="form-group animated zoomIn">
									<label class="control-label big-label text-muted text-uppercase" for="alasan_kelurahan_input">
										<span class="text-sm text-capitalize text-danger pull-right"><?php echo phrase('required'); ?></span>
										Alasan
									</label>
									<?php echo $field['alasan_kelurahan']['content']; ?>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group animated zoomIn">
								...
								<div class="form-group animated zoomIn">
									<label class="control-label big-label text-muted text-uppercase readonly" for="nama_kegiatan_input">
										Nama Kegiatan
									</label>
								...
								<div class="form-group animated zoomIn">
									<label class="control-label big-label text-muted text-uppercase readonly" for="id_prioritas_pembangunan_input">
