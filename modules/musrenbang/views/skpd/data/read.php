		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="form-group panel-group" id="data-table">
						<div class="panel panel-default">
							<div class="panel-heading no-padding">
								<a data-toggle="collapse" data-parent="#data-table" href="#collapse1">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-6">
											...
											<?php
												$variabel				= null;
												$variabel_usulan		= json_decode($view_data->variabel_usulan, true);
												if($variabel_usulan)
												{
													foreach($variabel_usulan as $key => $val)
													{
														$_variabel		= $this->model->get_where('ref__musrenbang_variabel', array('id' => $key), 1)->row();
														$variabel		.= '
															<div class="row">
																<div class="col-xs-2">
																	' . (isset($_variabel->kode_variabel) ? $_variabel->kode_variabel : 0) . '
																</div>
																<div class="col-xs-4">
																	' . (isset($_variabel->nama_variabel) ? $_variabel->nama_variabel : 0) . '
																</div>
																<div class="col-xs-4">
																	' . $val . '
																</div>
																<div class="col-xs-2">
																	' . (isset($_variabel->satuan) ? $_variabel->satuan : 0) . '
																</div>
															</div>
														';
													}
											...
											<div class="form-group">
												...
												<label class="control-label big-label">
													<?php
														if($view_data->flag == 0)
														{
															echo '<label class="label bg-silver">Usulan RW</label>';
														}
														elseif($view_data->flag == 1)
														{
															echo '<label class="label bg-green">Diterima Kelurahan</label>';
														}
														elseif($view_data->flag == 2)
														{
															echo '<label class="label bg-red">Ditolak Kelurahan</label>';
														}
														elseif($view_data->flag == 3)
														{
															echo '<label class="label bg-primary">Usulan Kelurahan</label>';
														}
														...
														{
															echo '<label class="label bg-red">Ditolak Kecamatan</label>';
														}
														elseif($view_data->flag == 6)
														{
															echo '<label class="label bg-primary">Usulan Kecamatan</label>';
														}
														elseif($view_data->flag == 7)
														{
															echo '<label class="label bg-green">Diterima SKPD</label>';
														}
														elseif($view_data->flag == 8)
														{
															echo '<label class="label bg-red">Ditolak SKPD</label>';
														}
													?>
												</label>
											</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading no-padding">
								<a data-toggle="collapse" data-parent="#data-table" href="#collapse2">
									<div class="info-box bg-default no-margin">
										<span class="info-box-icon">
											<i class="fa fa-info-circle"></i>
										</span>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-6">
											...
											<?php
												$variabel				= null;
												$variabel_kelurahan		= json_decode($view_data->variabel_kelurahan, true);
											...
											<div class="form-group">
												...
												<label class="control-label big-label">
													<?php
														if($view_data->flag == 0)
														{
															echo '<label class="label bg-silver">Usulan</label>';
														}
														elseif($view_data->flag == 1)
														{
															echo '<label class="label bg-green">Diterima Kelurahan</label>';
														...
														elseif($view_data->flag == 3)
														{
															echo '<label class="label bg-aqua">Usulan Kelurahan</label>';
														}
														elseif($view_data->flag == 4)
														{
															echo '<label class="label bg-blue">Diterima Kecamatan</label>';
														}
														elseif($view_data->flag == 5)
														{
															echo '<label class="label bg-purple">Ditolak Kecamatan</label>';
														}
														elseif($view_data->flag == 6)
														{
															echo '<label class="label bg-primary">Usulan Kecamatan</label>';
														...
														elseif($view_data->flag == 7)
														{
															echo '<label class="label bg-teal">Diterima SKPD</label>';
														}
														elseif($view_data->flag == 8)
														{
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-6">
											...
											<?php
												$variabel				= null;
												$variabel_kecamatan		= json_decode($view_data->variabel_kecamatan, true);
												if($variabel_kecamatan)
												{
													foreach($variabel_kecamatan as $key => $val)
													{
														$_variabel		= $this->model->get_where('ref__musrenbang_variabel', array('id' => $key), 1)->row();
														$variabel		.= '
															<div class="row">
											...
											<div class="form-group">
												...
												<label class="control-label big-label">
													Rp. <?php echo number_format($view_data->nilai_kecamatan, 2); ?>;
												</label>
											</div>
										</div>
										<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<?php
								$variabel				= null;
								if($view_data->variabel_skpd)
								{
									foreach($view_data->variabel_skpd as $key => $val)
									{
										$variabel		.= '
											<div class="row">
												<div class="col-xs-2">
							...
							<div class="form-group">
								...
								<label class="control-label big-label">
									Rp. <?php echo number_format($view_data->nilai_skpd, 2); ?>;
								</label>
							</div>
						</div>
						<div class="col-sm-6">
