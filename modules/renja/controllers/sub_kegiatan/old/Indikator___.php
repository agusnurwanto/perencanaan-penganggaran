...
class Indikator extends Aksara
{
	...
	public function index()
	{
		...
		(
			array
			(
				'renja/kegiatan/kegiatan'				=> 'kegiatan'
			)
		);
		$this->set_title('Indikator')
		->set_description('
			<div class="row">
		...
		->unset_column('id, id_keg, penjelasan')
		->unset_field('id, id_keg, penjelasan')
		->unset_view('id, id_keg')
		->unset_truncate('tolak_ukur')
		->add_action('toolbar', '../../../laporan/anggaran/rka_221', 'Preview RKA', 'btn-success ajax', 'fa fa-print', array('kegiatan' => $this->input->get('id_keg'), 'method' => 'preview'), true)
