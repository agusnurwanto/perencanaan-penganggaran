...
class Perda extends Aksara
{
	...
	public function __construct()
	{
		...
		$this->load->model('anggaran/Perda_model', 'report');
	...
	{
		$this->set_title('Laporan Peraturan Daerah')
	...
	public function lampiran_1()
	{
		...
		$this->_title								= 'Lampiran I Peraturan Daerah';
	...
	public function lampiran_2()
	{
		...
		$this->_title								= 'Lampiran II Peraturan Daerah';
	...
	public function lampiran_3()
	{
		...
		$this->_title								= 'Lampiran III Peraturan Daerah';
	...
	public function lampiran_4()
	{
		...
		$this->_title								= 'Lampiran IV Peraturan Daerah';
	...
	public function lampiran_5()
	{
		...
		$this->_title								= 'Lampiran V Peraturan Daerah';
	...
	public function lampiran_6()
	{
		...
		$this->_title								= 'Lampiran VI Peraturan Daerah';
	...
	public function lampiran_7()
	{
		...
		$this->_title								= 'Lampiran VII Peraturan Daerah';
	...
	public function lampiran_9()
	{
		...
		$this->_title								= 'Lampiran IX Peraturan Daerah';
		$this->_output								= $this->report->lampiran_9($this->_tahun, $this->_unit, $this->_sub_unit, $this->_jenis_anggaran);
		
		$this->_execute();
	}
	
	public function lampiran_10()
	{
		/*if(!$this->_kegiatan)
		{
		...
		$this->_title								= 'Lampiran X Peraturan Daerah';
		$this->_output								= $this->report->lampiran_10($this->_tahun, $this->_unit, $this->_sub_unit, $this->_jenis_anggaran);
		
		$this->_execute();
	}
	
	public function lampiran_11()
	{
		/*if(!$this->_kegiatan)
		{
		...
		$this->_title								= 'Lampiran XI Peraturan Daerah';
		$this->_output								= $this->report->lampiran_11($this->_tahun, $this->_unit, $this->_sub_unit, $this->_jenis_anggaran);
		
		$this->_execute();
	}
	
	public function lampiran_12()
	{
		/*if(!$this->_kegiatan)
		{
		...
		$this->_title								= 'Lampiran XII Peraturan Daerah';
		$this->_output								= $this->report->lampiran_12($this->_tahun, $this->_unit, $this->_sub_unit, $this->_jenis_anggaran);
		
		$this->_execute();
	}
	
	public function lampiran_13()
	{
		/*if(!$this->_jenis_data)
		{
		...
		$this->_title								= 'Lampiran XIII Peraturan Daerah';
		$this->_output								= $this->report->lampiran_13($this->_tahun, $this->_unit, $this->_sub_unit, $this->_jenis_anggaran);
		$this->_execute();
	}
	
	public function lampiran_14()
	{
		$this->_title								= 'Lampiran XIV Peraturan Daerah';
		$this->_output								= $this->report->lampiran_14($this->_tahun, $this->_unit, $this->_sub_unit, $this->_jenis_anggaran);
	
		$this->_execute();
	}
	
	public function lampiran_15()
	{
		$this->_title								= 'Lampiran XV Peraturan Daerah';
		$this->_output								= $this->report->lampiran_15($this->_tahun, $this->_unit, $this->_sub_unit, $this->_jenis_anggaran);

		$this->_execute();
	}
	
	public function lampiran_16()
	{
		...
		$this->_title								= 'Lampiran XVI Peraturan Daerah';
		$this->_output								= $this->report->lampiran_16($this->_tahun, $this->_unit, $this->_sub_unit, $this->_jenis_anggaran);
	...
	private function _reports()
	{
		...
		(
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran I',
				'description'						=> 'Ringkasan APBD, Kelompok dan Jenis Pendapatan, Belanja, dan Pembiayaan',
				'icon'								=> 'mdi-chart-arc',
				'color'								=> 'bg-primary',
				'placement'							=> 'left',
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran II',
				'description'						=> 'Ringkasan APBD, Urusan Pemerintahan Daerah dan Organisasi',
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran III',
				'description'						=> 'Rincian APBD menurut Urusan Pemerintahan Daerah, Organisasi, Program, Kegiatan, Sub Kegiatan, Kelompok, Jenis Pendapatan, Belanja, dan Pembiayaan',
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran IV',
				'description'						=> 'Rekapitulasi Belanja Menurut Urusan Pemerintahan Daerah, Organisasi, Program, Kegiatan Beserta Hasil dan Sub Kegiatan Beserta Keluaran',
				'icon'								=> 'mdi-chart-bar',
				'color'								=> 'bg-maroon',
				'placement'							=> 'left',
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran V',
				'description'						=> 'Rekapitulasi Belanja Daerah Untuk Keselarasan dan Keterpaduan Urusan Pemerintah Daerah dan Fungsi Dalam Kerangka Pengelolaan Keuangan Negara',
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran VI',
				'description'						=> 'Rekapitulasi Belanja Untuk Pemenuhan SPM',
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran VII',
				'description'						=> 'Sinkronisasi Program pada RPJMD dengan Rancangan APBD',
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran VIII',
				'description'						=> 'Sinkronisasi Program, Kegiatan dan Sub Kegiatan pada RKPD dan PPAS dengan Rancangan APBD',
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran IX',
				'description'						=> 'Sikronisasi Program Prioritas Nasional dengan Program Prioritas Daerah',
				'icon'								=> 'mdi-comment-check-outline',
				'color'								=> 'bg-primary',
				'placement'							=> 'right',
				'controller'						=> 'lampiran_9',
				'parameter'							=> array
				(
					'unit_sub_unit'					=> $this->_unit_sub_unit(),
					'jenis_anggaran'				=> $this->_jenis_anggaran()
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran X',
				'description'						=> 'Daftar Jumlah Pegawai Per Golongan dan Per Jabatan',
				'icon'								=> 'mdi-chart-pie',
				'color'								=> 'bg-teal',
				'placement'							=> 'right',
				'controller'						=> 'lampiran_10',
				'parameter'							=> array
				(
					'unit_sub_unit'					=> $this->_unit_sub_unit(),
					'jenis_anggaran'				=> $this->_jenis_anggaran()
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran XI',
				'description'						=> 'Daftar Piutang Daerah',
				'icon'								=> 'mdi-chart-timeline',
				'color'								=> 'bg-danger',
				'placement'							=> 'right',
				'controller'						=> 'lampiran_11',
				'parameter'							=> array
				(
					'unit_sub_unit'					=> $this->_unit_sub_unit(),
					'jenis_anggaran'				=> $this->_jenis_anggaran()
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran XII',
				'description'						=> 'Daftar Penyertaan Modal Daerah dan Investasi Daerah Lainnya',
				'icon'								=> 'mdi-credit-card',
				'color'								=> 'bg-maroon',
				'placement'							=> 'right',
				'controller'						=> 'lampiran_12',
				'parameter'							=> array
				(
					'unit_sub_unit'					=> $this->_unit_sub_unit(),
					'jenis_anggaran'				=> $this->_jenis_anggaran()
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran XIII',
				'description'						=> 'Daftar Perkiraan Penambahan dan Pengurangan Aset Tetap Daerah dan Aset Lain-Lain',
				'icon'								=> 'mdi-hexagon-slice-4',
				'color'								=> 'bg-success',
				'placement'							=> 'right',
				'controller'						=> 'lampiran_13',
				'parameter'							=> array
				(
					'unit_sub_unit'					=> $this->_unit_sub_unit(),
					'jenis_anggaran'				=> $this->_jenis_anggaran()
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran XIV',
				'description'						=> 'Daftar Sub Kegiatan Tahun Anggaran Sebelumnya Yang Belum Diselesaikan dan Dianggarkan Kembali Dalam Tahun Anggaran Yang Direncanakan',
				'icon'								=> 'mdi-database-plus',
				'color'								=> 'bg-info',
				'placement'							=> 'right',
				'controller'						=> 'lampiran_14',
				'parameter'							=> array
				(
					'unit_sub_unit'					=> $this->_unit_sub_unit(),
					'jenis_anggaran'				=> $this->_jenis_anggaran()
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran XV',
				'description'						=> 'Daftar Dana Cadangan',
				'icon'								=> 'mdi-database-search',
				'color'								=> 'bg-warning',
				'placement'							=> 'right',
				'controller'						=> 'lampiran_15',
				'parameter'							=> array
				(
					'unit_sub_unit'					=> $this->_unit_sub_unit(),
					'jenis_anggaran'				=> $this->_jenis_anggaran()
			...
			(
				//'user_group'						=> array(1),
				'title'								=> 'Lampiran XVI',
				'description'						=> 'Daftar Pinjaman Daerah',
				'icon'								=> 'mdi-printer-wireless',
				'color'								=> 'bg-green',
				'placement'							=> 'right',
				'controller'						=> 'lampiran_16',
				'parameter'							=> array
				(
					'unit_sub_unit'					=> $this->_unit_sub_unit(),
					'jenis_anggaran'				=> $this->_jenis_anggaran()
