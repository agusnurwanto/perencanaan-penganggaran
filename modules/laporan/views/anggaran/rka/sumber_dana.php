					...
					foreach($results['data'] as $key => $val)
					{
						...
						if($val->id_rek_2 != $id_rek_2)
						{
							echo '
								<tr>
									<td class="border text-sm">
										<b>' . $val->kd_sumber_dana_rek_1 . '.' . $val->kd_sumber_dana_rek_2 . '</b>
									</td>
						...
						if($val->id_rek_3 != $id_rek_3)
						{
							echo '
								<tr>
									<td class="border text-sm">
										<b>' . $val->kd_sumber_dana_rek_1 . '.' . $val->kd_sumber_dana_rek_2 . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_3) . '</b>
									</td>
						...
						if($val->id_rek_4 != $id_rek_4)
						{
							echo '
								<tr>
									<td class="border text-sm">
										<b>' . $val->kd_sumber_dana_rek_1 . '.' . $val->kd_sumber_dana_rek_2 . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_3) . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_4) . '</b>
									</td>
						...
						if($val->id_rek_5 != $id_rek_5)
						{
							echo '
								<tr>
									<td class="border text-sm">
										<b>' . $val->kd_sumber_dana_rek_1 . '.' . $val->kd_sumber_dana_rek_2 . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_3) . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_4) . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_5) . '</b>
									</td>
									<td style="padding-left:11px" class="border text-sm" colspan="2">
										<b>' . $val->uraian_rek_5 . '</b>
									</td>
								</tr>
							';
						}
						if($val->id_rek_6 != $id_rek_6)
						{
							echo '
								<tr>
									<td class="border text-sm">
										' . $val->kd_sumber_dana_rek_1 . '.' . $val->kd_sumber_dana_rek_2 . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_3) . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_4) . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_5) . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_6) . '
									</td>
									<td style="padding-left:14px" class="border text-sm" align="justify">
										' . $val->uraian_rek_6 . '
									</td>
									<td class="border text-sm" align="justify">
										' . $val->keterangan_rek_6 . '
									</td>
								</tr>
							';
						}
