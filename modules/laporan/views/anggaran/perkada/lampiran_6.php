...
<html>
	...
	<body>
		<table class="table">
			<thead>
				...
				<tr>
					...
					<th class="no-padding text-left" width="6%">
						Nomor
					</th>
			...
			<thead>
				<tr>
					...
					<th class="border no-border-left" align="center">
						...
						<h4>
							RINCIAN DBH-SDA PERTAMBANGAN MINYAK BUMI DAN PERTAMBANGAN GAS ALAM/TAMBAHAN DBH-MINYAK DAN GAS BUMI*)
							<br />
							MENURUT URUSAN PEMERINTAHAN DAERAH, ORGANISASI, PROGRAM, KEGIATAN, SUB KEGIATAN, KELOMPOK, JENIS, OBJEK, 
							<br />
		...
		<table class="table">
			<tr>
				<td class="border no-border-bottom no-border-right text-sm-2" width="8%">
					UNIT
				</td>
				<td class="border no-border-bottom no-border-left text-sm-2" width="92%">
					: x-xx.x-xx.x-xx.xx
				</td>
			</tr>
			<tr>
				<td class="border no-border-top no-border-right text-sm-2">
					SUB UNIT
				</td>
				<td class="border no-border-top no-border-left text-sm-2">
					: x-xx.x-xx.x-xx.xx
				</td>
			</tr>
		</table>
		<table class="table">
			<thead>
				<tr>
					...
					<th class="border text-sm-2" width="30%">
						Lokasi
					</th>
				</tr>
				<tr bgcolor="gray">
