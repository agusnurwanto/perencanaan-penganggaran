...
<html>
	...
	<body>
		...
		<table class="table">
			<thead>
				<tr>
					<th rowspan="2" class="border text-sm-2" width="5%">
						No
					</th>
					<th rowspan="2" class="border text-sm-2" width="17%">
						Prioritas Pembangunan
						<br />
						Nasional
					</th>
					<th rowspan="2" class="border text-sm-2" width="18%">
						Program
					</th>
					...
					<th colspan="4" class="border text-sm-2" width="35%">
						Alokasi Anggaran Belanja Dalam Rancangan APBD
					</th>
					<th colspan="2" class="border text-sm-2" width="15%">
						Jumlah
					</th>
				</tr>
				<tr>
					...
					<th class="border text-sm-2" width="7%">
						Belanja
						<br />
						Tansfer (Rp)
					</th>
					...
					<th class="border text-sm-2" width="6%">
						%
					</th>
				</tr>
				<tr bgcolor="gray">
