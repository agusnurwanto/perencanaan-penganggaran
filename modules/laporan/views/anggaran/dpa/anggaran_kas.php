	...
	<body>
		...
		<table class="table">
			...
			<tr>
				...
				<td class="border no-border-bottom no-border-top no-border-left no-padding">
					<?php echo $results['header']->nm_sub; ?>
				</td>
			</tr>
			<tr>
				<td class="border no-border-bottom no-border-top no-border-right no-padding" style="padding-left:8px">
				...
				<td class="no-padding">
					<?php echo $results['header']->kd_urusan . '.' . sprintf('%02d', $results['header']->kd_bidang) . '.' . sprintf('%02d', $results['header']->kd_unit) . '.' . sprintf('%02d', $results['header']->kd_sub) . '.' . sprintf('%02d', $results['header']->kd_program); ?>
				</td>
				<td class="border no-border-bottom no-border-top no-border-left no-padding">
			...
			<tr>
				...
				<td class="no-padding">
					<?php echo $results['header']->kd_urusan . '.' . sprintf('%02d', $results['header']->kd_bidang) . '.' . sprintf('%02d', $results['header']->kd_unit) . '.' . sprintf('%02d', $results['header']->kd_sub) . '.' . sprintf('%02d', $results['header']->kd_program) . '.' . sprintf('%02d', $results['header']->kd_keg); ?>
				</td>
				<td class="border no-border-bottom no-border-top no-border-left no-padding">
			...
			<tr>
				...
				<td class="no-padding">
					<?php echo $results['header']->kd_urusan . '.' . sprintf('%02d', $results['header']->kd_bidang) . '.' . sprintf('%02d', $results['header']->kd_unit) . '.' . sprintf('%02d', $results['header']->kd_sub) . '.' . sprintf('%02d', $results['header']->kd_program) . '.' . sprintf('%02d', $results['header']->kd_keg) . '.' . sprintf('%02d', $results['header']->kd_keg_sub); ?>
				</td>
				<td class="border no-border-bottom no-border-top no-border-left no-padding">
			...
			<tr>
				...
				<td class="border no-border-top no-border-left no-padding">
					<?php echo spell_number($results['header']->pagu); ?> Rupiah
				</td>
			</tr>
		</table>
		<table class="table">
			...
			<tbody>
				<?php
					...
					foreach($results['data'] as $key => $val)
					{
						...
						{
							$selisih_rek_6					= $val->pagu_rek_6 - $val->rencana_rek_6_tw_1 - $val->rencana_rek_6_tw_2 - $val->rencana_rek_6_tw_3 - $val->rencana_rek_6_tw_4;
							echo '	
								<tr>
									<td class="border">
										' . $val->kd_rek_1 . '.' . $val->kd_rek_2 . '.' . $val->kd_rek_3 . '.' . sprintf('%02d', $val->kd_rek_4) . '.' . sprintf('%02d', $val->kd_rek_5) . '.' . sprintf('%02d', $val->kd_rek_6) . '
									</td>
									<td style="padding-left:18px" class="border">
										' . $val->uraian_rek_6 . '
									</td>
									<td class="border" align="right">
										' . number_format_indo($val->pagu_rek_6, 2) . '
									</td>
									<td class="border" align="right">
										' . number_format_indo($val->rencana_rek_6_tw_1, 2) . '
									</td>
									<td class="border" align="right">
										' . number_format_indo($val->rencana_rek_6_tw_2, 2) . '
									</td>
									<td class="border" align="right">
										' . number_format_indo($val->rencana_rek_6_tw_3, 2) . '
									</td>
									<td class="border" align="right">
										' . number_format_indo($val->rencana_rek_6_tw_4, 2) . '
									</td>
									<td class="border" align="right">
										' . number_format_indo($selisih_rek_6, 2) . '
									</td>
								</tr>
							';
						}
						...
						$total_rekening					+= $val->pagu_rek_6;
						$total_tw_1						+= $val->rencana_rek_6_tw_1;
						$total_tw_2						+= $val->rencana_rek_6_tw_2;
						$total_tw_3						+= $val->rencana_rek_6_tw_3;
						$total_tw_4						+= $val->rencana_rek_6_tw_4;
						$total_selisih					+= $selisih_rek_6;
					}
				?>
			</tbody>
				<tr>
