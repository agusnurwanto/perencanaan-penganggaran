							...
							echo '
								<tr>
									...
									<td class="bordered" align="center">
										' . ($val['perencanaan'] == 1 ? "<b>Selesai</b>" : "Belum") . '
									</td>
									<td class="bordered" align="center">
										' . ($val['keuangan'] == 1 ? "<b>Selesai</b>" : "Belum") . '
									</td>
									<td class="bordered" align="center">
										' . ($val['setda'] == 1 ? "<b>Selesai</b>" : "Belum") . '
									</td>
									<td class="bordered" align="center">
										' . ($val['ttd_1'] == 1 ? "<b>Selesai</b>" : "Belum") . '
									</td>
									<td class="bordered" align="center">
										' . ($val['ttd_2'] == 1 ? "<b>Selesai</b>" : "Belum") . '
									</td>
									<td class="bordered" align="center">
										' . ($val['ttd_3'] == 1 ? "<b>Selesai</b>" : "Belum") . '
									</td>
								</tr>
							';
						}
