								...
								<div id="collapse_' . $key . '" class="panel-collapse collapse">
									<div class="panel-body">
										<form action="' . go_to($val['method']) . '" method="GET" target="_blank" class="form-sm">
											'  . (isset($val['misi']) ? $val['misi'] : null) . '
											'  . (isset($val['skpd']) ? $val['skpd'] : null) . '
											'  . (isset($val['jenis_bl']) ? $val['jenis_bl'] : null) . '
											<div class="row form-group">
												<div class="col-sm-12">
													...
													<br />
													<input type="text" name="tanggal_cetak" class="form-control input-sm" placeholder="' . phrase('pilih_tanggal_cetak') . '" value="' . date('Y-m-d') . '" role="datepicker" />
												</div>
											</div>
											<div class="row form-group">
												<div class="col-sm-12">
