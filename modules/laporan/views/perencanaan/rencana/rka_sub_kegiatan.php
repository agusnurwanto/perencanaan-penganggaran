					...
					<td colspan="3" class="border">
						<table>
							...
							<tr>
								...
								<td class="text-sm-2 no-padding">
									<i>(<?php echo (isset($results['header']->pagu_1) && $results['header']->pagu_1 > 0 ? spell_number($results['header']->pagu_1) : 'Nol'); ?> Rupiah )</i>
								</td>
							</tr>
						</table>
					</td>
				...
				<tfoot>
					...
					<tr>
						<td class="border text-sm no-border-right" colspan="3">
							<i>
								RKA Sub Kegiatan - <?php echo (isset($results['header']->kegiatan_sub) ? $results['header']->kegiatan_sub : '-'); ?>
