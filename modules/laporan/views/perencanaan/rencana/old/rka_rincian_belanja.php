...
<html>
	...
	<body>
						...
						<table>
							...
							<tr>
								...
								<td width="58%" class="text-sm-2 no-padding">
									<i>(<?php echo (isset($results['header']->total_pagu_kegiatan) && $results['header']->total_pagu_kegiatan > 0 ? spell_number($results['header']->total_pagu_kegiatan) : 'Nol'); ?> Rupiah )</i>
								</td>
							</tr>
							<tr>
								<td class="text-sm-2 no-padding">
								...
								<td class="text-sm-2 no-padding">
									<i>(<?php echo (isset($results['header']->total_pagu_kegiatan_1) && $results['header']->total_pagu_kegiatan_1 > 0 ? spell_number($results['header']->total_pagu_kegiatan_1) : 'Nol'); ?> Rupiah )</i>
								</td>
							</tr>
						</table>
					</td>
		...
		<table class="table">
			...
			<tr>
				<th class="border" rowspan="2" width="20%">
					Indikator
				</th>
			...
			<?php
				...
				$masukan	.= '<td class="border text-sm">
									Jumlah Dana
								</td>
								<td class="border text-sm">
					...
					elseif($val->jns_indikator == 2)
					{
						...
						//{
							$keluaran	.= ($keluaran ? '
												...
												<td class="border text-sm">' . $val->tolak_ukur . '
												</td>
												<td class="border text-sm">' . $val->tolak_ukur . '
												</td>
												<td class="border text-sm">' . (fmod($val->target, 1) !== 0.00 ? number_format_indo($val->target, 2) : number_format_indo($val->target, 0)) . ' ' . $val->satuan . '
												</td>
												<td class="border text-sm">' . (fmod($val->target, 1) !== 0.00 ? number_format_indo($val->target, 2) : number_format_indo($val->target, 0)) . ' ' . $val->satuan . '
												</td>
											</tr>
			...
			<tr>
				...
				<?php echo ($keluaran ? $keluaran : '<td colspan="2" class="border text-sm"></td>'); ?>
			</tr>
			<tr>
				<td class="border text-sm">
					<b>Hasil</b>
				</td>
				<?php echo ($hasil ? $hasil : '<td colspan="2" class="border text-sm"></td>'); ?>
			</tr>
			<tr>
									...
									<td class="border" colspan="6">
										<table class="table">
											...
											<tr>
												...
												<td class="no-padding">
													Mulai ' . date('F', strtotime($val->waktu_pelaksanaan_mulai)) . '
												</td>
												<td class="no-padding" colspan="3">
													Sampai ' . date('F', strtotime($val->waktu_pelaksanaan_sampai)) . '
												</td>
											</tr>
										</table>
									</td>
		...
		<htmlpagefooter name="footer">
			<table class="table print">
				<tfoot>
					<tr>
						<td class="border text-center text-sm" colspan="4">
							<b>PARAF TIM ASISTENSI</b>
						</td>
					</tr>
					<tr>
						<td class="border text-sm" width="33%">
							<b>1. <?php echo $results['tim_anggaran'][0]->opd; ?> </b>
						...
						<td class="border text-sm" width="33%">
							<b>2. <?php echo $results['tim_anggaran'][1]->opd; ?> </b>
						...
						<td class="border text-sm" width="34%" colspan="2">
							<b>3. <?php echo $results['tim_anggaran'][2]->opd; ?> </b>
