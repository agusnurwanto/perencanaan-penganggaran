			...
			<thead>
				...
				<?php
					...
					foreach($results['data'] as $key => $val)
					{
						...
						if($val->id_sub_kegiatan != $id_sub_kegiatan)
						{
							$jumlah_belanja_sub_kegiatan	=	$val->belanja_operasi_sub_kegiatan + $val->belanja_modal_sub_kegiatan + $val->belanja_tidak_terduga_sub_kegiatan + $val->belanja_operasi_sub_kegiatan;
							echo '
								<tr>
									<td class="border text-sm">
										' . $val->kd_urusan . '.' . $val->kd_bidang . '.' . sprintf('%02d', $val->kd_program) . '.' . sprintf('%02d', $val->kd_keg) . '.' . sprintf('%02d', $val->kd_keg_sub) . '
									</td>
									<td style="padding-left:11px" class="border text-sm">
										' . $val->kegiatan_sub . '
									</td>
									<td class="border text-sm">
										' . $val->kd_sumber_dana_rek_1 . '.' . $val->kd_sumber_dana_rek_2 . '.' . $val->kd_sumber_dana_rek_3 . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_4) . '.' . sprintf('%02d', $val->kd_sumber_dana_rek_5) . '.' . sprintf('%02d', $val->kode) . '.' . $val->nama_sumber_dana . '
									</td>
									<td class="border text-sm">
									...
									<td class="border text-right text-sm">
										' . number_format_indo($val->belanja_operasi_sub_kegiatan) . '
									</td>
									<td class="border text-right text-sm">
										' . number_format_indo($val->belanja_modal_sub_kegiatan) . '
									</td>
									<td class="border text-right text-sm">
										' . number_format_indo($val->belanja_tidak_terduga_sub_kegiatan) . '
									</td>
									<td class="border text-right text-sm">
										' . number_format_indo($val->belanja_transfer_sub_kegiatan) . '
									</td>
									<td class="border text-right text-sm">
