	...
	<body>
		...
		<table class="table">
			<tr>
				...
				<td width="72%">
					<?php echo (isset($results['approval']->perencanaan) && 1 == $results['approval']->perencanaan ? 'Disetujui Oleh <b>' . $results['approval']->nama_operator_perencanaan . '</b> pada ' . date_indo($results['approval']->waktu_verifikasi_perencanaan, 3, '-') : 'Belum Disetujui'); ?>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<?php echo (isset($results['approval']->keuangan) && 1 == $results['approval']->keuangan ? 'Disetujui Oleh <b>' . $results['approval']->nama_operator_keuangan . '</b> pada ' . date_indo($results['approval']->waktu_verifikasi_keuangan, 3, '-') : 'Belum Disetujui'); ?>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<?php echo (isset($results['approval']->setda) && 1 == $results['approval']->setda ? 'Disetujui Oleh <b>' . $results['approval']->nama_operator_setda . '</b> pada ' . date_indo($results['approval']->waktu_verifikasi_setda, 3, '-') : 'Belum Disetujui'); ?>
				</td>
			</tr>
		</table>
		<br />
