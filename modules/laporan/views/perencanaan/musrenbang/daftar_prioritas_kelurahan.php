...
<html>
	<head>
		<title>
			Daftar Kegiatan Prioritas Kelurahan
		</title>
		...
		<table class="table" align="center">
			<tr>
				...
				<th class="border no-border-left" align="center" width="100%" colspan="6">
					...
					<h4>
						DAFTAR URUTAN KEGIATAN PRIORITAS KELURAHAN MENURUT PERANGKAT DAERAH
					</h4>
					<h4>
			...
			<tbody>
				<?php
					...
					foreach($results['data'] as $key => $val)
					{
						...
						$volume								= json_decode($val['variabel_kelurahan'], true/* true mean the result would be format as array instead of object */);
						...
						echo '
							<tr>
								...
								<td class="border" align="right">
									' . number_format_indo($val['nilai_kelurahan']) . '
								</td>
								<td class="border">
		...
		<table class="table" style="page-break-inside:avoid">
			<tr>
				...
				<td class="border no-border-left" width="40%">
					...
					<br />
						<b><?php echo (isset($results['header']->jabatan_lurah) ? $results['header']->jabatan_lurah : null); ?></b>
					<br />
					<br />
					<br />
					<br />
					<br />
					<br />
					<u><b><?php echo (isset($results['header']->nama_lurah) ? $results['header']->nama_lurah : null); ?></b></u>
					<br />
