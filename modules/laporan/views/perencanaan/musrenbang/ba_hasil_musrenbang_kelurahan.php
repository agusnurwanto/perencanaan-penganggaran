...
<html>
	...
	<body>
		<table align="center">
			<tr>
				...
				<td align="center" width="100%">
					...
					<h4>
						KELURAHAN <?php echo (isset($results['header']->nama_kelurahan) ? strtoupper($results['header']->nama_kelurahan) : null); ?>
					</h4>
					<h4>
						KECAMATAN <?php echo (isset($results['header']->nama_kecamatan) ? strtoupper($results['header']->nama_kecamatan) : null); ?>
					</h4>
					<h4>
		...
		<div class="text-justify">
			<p>
			&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Pada hari ini, <?php echo phrase(date("l",strtotime($this->input->get('tanggal_cetak')))); ?> Tanggal <?php echo spell_number(date("j",strtotime($this->input->get('tanggal_cetak')))); ?> Bulan <?php echo phrase(date("F",strtotime($this->input->get('tanggal_cetak')))); ?> Tahun <?php echo spell_number(date("Y",strtotime($this->input->get('tanggal_cetak')))); ?> telah dilaksanakan Musyawarah Perencanaan Pembangunan (Musrenbang) Kelurahan <?php echo (isset($results['header']->nama_kelurahan) ? $results['header']->nama_kelurahan : null); ?> bertempat di Kelurahan <?php echo (isset($results['header']->nama_kelurahan) ? $results['header']->nama_kelurahan : null); ?> dan berlangsung sesuai dengan acara pada Lampiran I.
			</p>
			<p>			
			&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Musrenbang Kelurahan <?php echo (isset($results['header']->nama_kelurahan) ? $results['header']->nama_kelurahan : null); ?> tersebut dipimpin oleh <?php echo (isset($results['header']->nama_lurah) ? $results['header']->nama_lurah : null); ?>, serta dihadiri oleh ........ orang peserta, sebagaimana daftar hadir tersebut pada Lampiran II, yang terdiri dari atas unsur-unsur sebagai berikut :
			</p>
			<table border="0" cellpadding="0">
				...
				<tr>
					...
					<td>
						Wakil dari kelompok-kelompok masyarakat yang lingkup kegiatannya dalam skala kelurahan, meliputi:
					</td>
					<td>
			...
			<table border="0" cellpadding="0">
				...
				<tr>
					...
					<td>
						Rancangan prioritas kegiatan di kelurahan serta perkiraan jumlah alokasi dana kelurahan;
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						Daftar prioritas kegiatan pembangunan masing-masing RT dan RW yang dihasilkan dari musyawarah RT dan RW.
					</td>
				</tr>
			</table>
			<p>
			...
			<table border="0" cellpadding="0">
				<tr>
					...
					<td width="95%">
						Daftar penyelesaian masalah serta usulan kegiatan kelurahan yang akan dibiayai oleh APBD Kota, APBD Provinsi, APBN dan sumber dana lainnya (Lampiran IV);
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						Mendelegasikan dan memberikan mandat kepada 3 (tiga) orang anggota masyarakat untuk memperjuangkan usulan kegiatan pembangunan pada Musrenbang Kecamatan dengan Surat Mandat sebagaimana terlampir (Lampiran VI).
					</td>
				</tr>
			</table>
			<p>
			...
			<tr>
				<td class="text-center" width="50%">
					...
					<b>
						...
						<br />
						Selaku Penanggungjawab Musrenbang Kelurahan,
					</b>
					<br />
					<br />
					<br />
				...
				<td class="text-center" width="50%">
					...
					<br />
						<b>
							KETUA TIM PENYELENGGARA MUSRENBANG KELURAHAN <?php echo (isset($results['header']->nama_kelurahan) ? $results['header']->nama_kelurahan : null); ?>
						</b>
					<br />
					<br />
					<br />
