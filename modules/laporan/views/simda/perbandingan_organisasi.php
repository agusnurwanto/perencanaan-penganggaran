		...
		<table class="table">
			...
			<tbody>
				<?php
					...
					{
						if((isset($val['kd_urusan']) ? $val['kd_urusan'] : (isset($val['kd_urusan_simda']) ? $val['kd_urusan_simda'] : 0)) != $kd_urusan)
						{
							echo '
								<tr' . ((isset($val['nm_urusan']) && isset($val['nm_urusan_simda']) && $val['nm_urusan'] != $val['nm_urusan_simda']) || (!isset($val['kd_urusan']) || !isset($val['nm_urusan']) || !isset($val['kd_urusan_simda']) || !isset($val['nm_urusan_simda'])) ? ' bgcolor="#ffcccc"' : null) . '>
									<td class="bordered">
						...
						if((isset($val['kd_urusan']) ? $val['kd_urusan'] : (isset($val['kd_urusan_simda']) ? $val['kd_urusan_simda'] : 0)) != $kd_urusan || (isset($val['kd_bidang']) ? $val['kd_bidang'] : (isset($val['kd_bidang_simda']) ? $val['kd_bidang_simda'] : 0)) != $kd_bidang)
						{
							echo '
								<tr' . ((isset($val['nm_bidang']) && isset($val['nm_bidang_simda']) && $val['nm_bidang'] != $val['nm_bidang_simda']) || (!isset($val['kd_urusan']) || !isset($val['kd_bidang']) || !isset($val['nm_urusan']) || !isset($val['kd_urusan_simda']) || !isset($val['kd_bidang_simda']) || !isset($val['nm_urusan_simda'])) ? ' bgcolor="#ffcccc"' : null) . '>
									<td class="bordered">
						...
						if((isset($val['kd_urusan']) ? $val['kd_urusan'] : (isset($val['kd_urusan_simda']) ? $val['kd_urusan_simda'] : 0)) != $kd_urusan || (isset($val['kd_bidang']) ? $val['kd_bidang'] : (isset($val['kd_bidang_simda']) ? $val['kd_bidang_simda'] : 0)) != $kd_bidang || (isset($val['kd_unit']) ? $val['kd_unit'] : (isset($val['kd_unit_simda']) ? $val['kd_unit_simda'] : 0)) != $kd_unit)
						{
							echo '
								<tr' . ((isset($val['nm_unit']) && isset($val['nm_unit_simda']) && $val['nm_unit'] != $val['nm_unit_simda']) || (!isset($val['kd_urusan']) || !isset($val['kd_bidang']) || !isset($val['kd_unit']) || !isset($val['nm_urusan']) || !isset($val['kd_urusan_simda']) || !isset($val['kd_bidang_simda']) || !isset($val['kd_unit_simda']) || !isset($val['nm_urusan_simda'])) ? ' bgcolor="#ffcccc"' : null) . '>
									<td class="bordered">
						...
						if((isset($val['kd_urusan']) ? $val['kd_urusan'] : (isset($val['kd_urusan_simda']) ? $val['kd_urusan_simda'] : 0)) != $kd_urusan || (isset($val['kd_bidang']) ? $val['kd_bidang'] : (isset($val['kd_bidang_simda']) ? $val['kd_bidang_simda'] : 0)) != $kd_bidang || (isset($val['kd_unit']) ? $val['kd_unit'] : (isset($val['kd_unit_simda']) ? $val['kd_unit_simda'] : 0)) != $kd_unit || (isset($val['kd_sub']) ? $val['kd_sub'] : (isset($val['kd_sub_simda']) ? $val['kd_sub_simda'] : 0)) != $kd_sub)
						{
							echo '
								<tr' . ((isset($val['nm_sub']) && isset($val['nm_sub_simda']) && $val['nm_sub'] != $val['nm_sub_simda']) || (!isset($val['kd_urusan']) || !isset($val['kd_bidang']) || !isset($val['kd_unit']) || !isset($val['kd_sub']) || !isset($val['nm_urusan']) || !isset($val['kd_urusan_simda']) || !isset($val['kd_bidang_simda']) || !isset($val['kd_unit_simda']) || !isset($val['kd_sub_simda']) || !isset($val['nm_urusan_simda'])) ? ' bgcolor="#ffcccc"' : null) . '>
									<td class="bordered">
