...
<html>
	<head>
		<title>
			Rekapitulasi Renja Awal per SKPD
		</title>
		...
		<table align="center">
			<tr>
				...
				<td align="center" width="100%">
					...
					<h4>
						REKAPITULASI RENCANA KERJA AWAL PER SKPD
					</h4>
					<h4>
		...
		<table class="table">
			...
			<tbody>
				<?php
					...
					{
						$total_kegiatan						+= $val['jumlah_kegiatan_skpd'];
						$total_plafon						+= $val['plafon_anggaran_skpd'];
						...
						echo '
							<tr>
								...
								<td class="bordered text-right">
									' . number_format($val['jumlah_kegiatan_skpd']) . '									
								</td>
								<td class="bordered text-right">
									' . number_format($val['plafon_anggaran_skpd']) . '
								</td>
							</tr>
						';
					}
			...
			<tr>
				...
				<td class="bordered text-right">
					<b>
						<?php echo number_format($total_kegiatan); ?>
					</b>
				</td>
				<td class="bordered text-right">
					<b>
						<?php echo number_format($total_plafon); ?>
					</b>
				</td>
			</tr>
		</table>
