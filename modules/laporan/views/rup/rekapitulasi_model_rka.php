	...
	<body>
		...
		<table class="table">
						...
						echo '
							<tr>
								...
								<td class="bordered text-right">
									' . number_format($val['rka']) . '
								</td>
								<td class="bordered text-right">
									' . number_format($val['model']) . '
								</td>
								<td class="bordered text-right">
			...
			<tr>
				...
				<td class="bordered text-right">
					<b>
						<?php echo number_format($total_rka); ?>
					</b>
				</td>
				<td class="bordered text-right">
					<b>
						<?php echo number_format($total_model); ?>
					</b>
				</td>
				<td class="bordered text-right">
					<b>
						<?php echo number_format($total_rka + $total_model); ?>
					</b>
				</td>
			</tr>
		</table>
