		...
		<table align="center">
			<tr>
				...
				<td align="center" width="100%" colspan="9">
					...
					<h4>
						RENCANA KERJA AKHIR <?php echo (isset($nama_pemda) ? strtoupper($nama_pemda) : "") ; ?>
					</h4>
					<h4>
					<?php
			...
			<table class="print">
				<tr>
					<td class="text-muted text-sm" colspan="2">
						...
						?>
							Kompilasi Program dan Pagu Indikatif Rencana Kerja Akhir Tahun <?php echo get_userdata('year'); ?>
						</i>
					</td>
