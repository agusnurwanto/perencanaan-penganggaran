...
class Rencana_keuangan extends Aksara
{
	...
	function __construct()
	{
		...
		{
			return generateMessages(301, phrase('silakan_memilih_rekening_terlebih_dahulu'), go_to('../rekening'));
		}
	...
	private function _validate_form()
	{
		...
		{
			generateMessages(400, array(validation_errors('<p><i class="fa fa-ban"></i> &nbsp; ', '</p>')));
		}
		else
		{
			$prepare								= array
			...
			if($execute)
			{
				...
				generateMessages(301, phrase('data_was_successfully_submitted'), go_to());
			}
			else
			{
				generateMessages(500, phrase('something_went_wrong_while_submitting_your_data'));
			}
		}
	}
