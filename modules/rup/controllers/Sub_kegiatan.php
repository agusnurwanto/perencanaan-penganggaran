...
class Sub_kegiatan extends Aksara
{
	...
	public function index()
	{
		...
		(
			array
			(
				'rup/kegiatan/sub_unit'				=> 'Sub Unit',
				'../'								=> 'Kegiatan'
			)
		);
