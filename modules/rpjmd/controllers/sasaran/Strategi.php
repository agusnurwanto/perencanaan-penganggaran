...
class Strategi extends Aksara
{
	private $_table									= 'ta__rpjmd_strategi'; 
	...
	{
		$last_code											= $this->model->select_max('kode')->get_where('ta__rpjmd_sasaran', array('id_rpjmd_strategi' => $this->input->post('isu')), 1)->row('kode');
