...
class Sub_unit extends Aksara
{
	function __construct()
	{
		...
		if(in_array(get_userdata('group_id'), array(11, 12)))
		{
			...
			return throw_exception(301, 'Silakan Pilih Kegiatan...', current_page('../kegiatan', array('sub_unit' => get_userdata('sub_level_1'))));
		}
	...
	public function index()
	{
		...
		->set_field('nm_sub', 'hyperlink', 'monev/kegiatan', array('sub_unit' => 'id'))
