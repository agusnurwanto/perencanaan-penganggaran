		...
		<div class="row">
			<div class="col-md-6 offset-md-3">
				<div class="form-group mb-4">
					...
					<input type="text" name="first_name" class="form-control form-control-lg font-weight-light" id="first_name_input" placeholder="<?php echo phrase('name_as_shown_on_id'); ?>" autocomplete="off" maxlength="64" />
				</div>
				<div class="form-group mb-4">
					<label class="d-block font-weight-bold" for="username_input">
						<?php echo phrase('username'); ?>
					</label>
					<input type="text" name="username" class="form-control form-control-lg font-weight-light" id="username_input" placeholder="<?php echo phrase('choose_your_login_username'); ?>" autocomplete="off" maxlength="32" />
				</div>
				<div class="form-group mb-4">
					<label class="d-block font-weight-bold" for="email_input">
						<?php echo phrase('email_address'); ?>
					</label>
					<input type="email" name="email" class="form-control form-control-lg font-weight-light" id="email_input" placeholder="<?php echo phrase('type_your_email_address'); ?>" autocomplete="off" maxlength="128" />
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="form-group mb-4">
							...
							<div class="input-group">
								<div class="input-group-prepend">
									<span class="input-group-text bg-dark p-0">
										<img src="<?php echo $captcha; ?>" class="img-fluid" alt="..." />
									</span>
								</div>
